...
lazy val root = (project in file("."))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "org.tpolecat"        %% "doobie-core"          % DoobieVersion                 withSources() withJavadoc(),
      "org.tpolecat"        %% "doobie-postgres"      % DoobieVersion                 withSources() withJavadoc(),
      "org.tpolecat"        %% "doobie-hikari"        % DoobieVersion                 withSources() withJavadoc(),

      "io.github.jmcardon"  %% "tsec-md"              % TsecVersion                   withSources() withJavadoc(),
      "io.github.jmcardon"  %% "tsec-common"          % TsecVersion                   withSources() withJavadoc(),

      "org.specs2"          %% "specs2-core"          % Specs2Version       % "test"  withSources() withJavadoc(),
